...
## Ejemplo: Número de DAM1 según calidad de las estimaciones / Example: Number of MAD1 according to quality of estimates
...
![Publicaciones](Recursos/00_Introduccion/03a_Fig_publicado.png){width="450"}
...
1. En 2023, la CEPAL se unió a la FAO para apoyar al gobierno chileno en las estimaciones de FIES en municipios.
...
3. En 2023, la División de Estadística de las Naciones Unidas, la CEPAL y el UNFPA lanzaron la Capacitación Global sobre Métodos SAE donde los investigadores más influyentes del mundo grabaron sesiones de capacitación.

- Dos versiones de la Capacitación Global (autodidacta y guiada).
- Partha Lahiri, Isabel Molina, Pedro Silva, Mónica Pratesi, entre otros.
- 10 módulos.
...
![Mas de UGMs Rural](Recursos/01_Census_Filters/Mapas_UGMS.png){width="350"}

## Limitaciones identificadas en la base. 

![Mas de UGMs Urbano](Recursos/01_Census_Filters/Mapa cobertura vivienda.jpg){width="350"}
